  ...
  return (
    <div className="p-8 bg-white rounded-lg shadow-lg w-[70%] mx-auto mt-9 mb-[100px]" >
        ...
        <div className="mb-6">
            ...
            <li>
                <strong>Collect data for a Minerva chatbot:</strong> A small group of students and faculty are working to design a custom AI tool for Minervans. We envision a chatbot that serves as a learning guide and is trained on Minerva’s specific curriculum (e.g., HCs, LOs, classes, assignments) and pedagogy (e.g., active learning, reflection, deliberate practice). We are confident that we can effectively embed our curriculum to make our AI tutor knowledgeable about Minerva’s course content, however, getting it to behave like an experienced capable guide is more challenging. LLMs were typically trained to be knowledgeable and convincing, but we want our tool to play more of a guiding role to lead the student to understand on their own. This is challenging because fine tuning the behavior of the AI tutor would take large amounts of high-quality data containing “good” conversations between students and tutors with “exemplar” tutor behavior (see list below). There is some data out there, and even Minerva class transcripts might be helpful, but most of the existing data is low quality or not structured properly for fine tuning. We hope that the data collected through this project will help improve our chatbot’s behavior and ability to guide students effectively.
                <p className='px-3 font-bold'>
                    Minerva’s IRB has consulted on this data collection project and confirmed that it falls <a href='https://irb.minerva.edu/educational-research/' className='underline text-blue-500'>under internal educational research</a>. After we train this model more, we might use it as part of further data collection and even human subjects research, and there is a chance that we will share findings outside of Minerva. When appropriate, we will acknowledge the work of people who contributed to this training stage of the model, but we will never publicly connect your name or email address to your specific chats with the AI.

                </p>
            </li>
            <li>
                <strong>Practice your tutoring techniques:</strong> Whether you’re a new or experienced teacher, we could all use a refresher on effective teaching practices. Even though the standards of effective tutoring may not be well defined in the education literature, there are some qualities we want to strive for 
